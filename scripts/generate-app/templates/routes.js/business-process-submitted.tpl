...
module.exports = {
	'/': require('eregistrations/view/business-process-submitted'),
	profile: require('eregistrations/view/user-profile'),
	'data-print': require('eregistrations/view/print-business-process-data'),
	'document/[a-z][a-z0-9-]*': {
	...
	'print-request-history': require('eregistrations/view/print-business-process-status-log')
};
