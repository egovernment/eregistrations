...
exports._headerNav = function () {
	return ul({ class: 'header-top-menu', id: 'menu' },
		li(a('en')),
		li(a('sw')),
		li(a('link one')),
		li(a('link two')),
...
exports._appNavDialogHeaderTitle = function () {
	return h4("Application navigation");
};

exports._appNavDialogList = function () {
	return ol(
		li(
