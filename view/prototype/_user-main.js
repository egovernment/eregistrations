				...
				ul({ class: 'user-steps-menu-list' },
					li(
						a({ href: '/guide/', id: 'step-guide' },
							"1. Guide"),
						div({ class: 'users-steps-menu-item-progress', style: 'width: 100%' })
					),
					li(
						a({ href: '/forms/', id: 'step-form' },
							"2. Fill the form"
							),
						div({ class: 'users-steps-menu-item-progress', style: 'width: 50%' })
					),
					li(
						a({ href: '/documents/', id: 'step-documents' },
							"3. Upload docs"
							),
						div({ class: 'users-steps-menu-item-progress' })
					),
					li(
						a("4. Pay"
							),
