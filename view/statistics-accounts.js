...
exports['statistics-main'] = function () {
	...
	table({ class: 'statistics-table' },
		...
		tbody(
			tr({ class: 'statistics-table-sub-header statistics-table-sub-header-blue' }, td(_("Accounts of Part A")),
			...
			tr({ class: 'statistics-table-sub-header statistics-table-sub-header-grey' }, td(_("Operators of Part B")),
			...
			tr({ class: 'statistics-table-sub-header statistics-table-sub-header-orange' }, td(_("Admin accounts")),
			...
			tr({ class: 'statistics-table-sub-header statistics-table-sub-header-violet' }, td(_("Demo accounts")),
